...
export default function App() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      ...
      if (user && (user.email === 'youssefbenamor1234@gmail.com' || user.email === 'youssefbenamor@gmail.com')) {
    ...
    <div className="min-h-screen bg-transparent flex flex-col">
      ...
      <main className="flex-grow pt-24">
        {view === 'admin' ? (
          ...
          <>
            <Hero searchCriteria={searchCriteria} setSearchCriteria={setSearchCriteria} />
            <CarFleet onCheck={setSelectedCar} searchCriteria={searchCriteria} />
            <WhyChooseUs />
            <Testimonials />
            <FAQ />
            <LocationMap />
